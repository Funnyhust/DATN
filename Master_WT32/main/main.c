...
//         snprintf(lcd_buffer, sizeof(lcd_buffer), "Humi:100 100 100");
//         esp32_lcd_i2c_set_cursor(&lcd, 0, 0);
//         esp32_lcd_i2c_print(&lcd, lcd_buffer);
...
//         snprintf(lcd_buffer, sizeof(lcd_buffer), "Status:1 1 1");
//         esp32_lcd_i2c_set_cursor(&lcd, -4, 2);
//         esp32_lcd_i2c_print(&lcd, lcd_buffer);

//         snprintf(lcd_buffer, sizeof(lcd_buffer), "Canh bao muc:0");
//         esp32_lcd_i2c_set_cursor(&lcd, -4, 3);
//         esp32_lcd_i2c_print(&lcd, lcd_buffer);
